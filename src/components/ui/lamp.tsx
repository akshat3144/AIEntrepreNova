  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="bg-gradient-to-br from-slate-300 to-slate-500 bg-clip-text text-center text-5xl md:text-6xl font-bold tracking-tight text-transparent "
      >
        AIEntrepreNova
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0 min-h-screen",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-full bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-full bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
